...
import { BsHouseDoor, BsSearch, BsFillInboxFill} from "react-icons/bs";
                ...
                <div className="d-flex flex-column navbar">
                    ...
                    <ul className="nav nav-pills flex-column mb-auto">
                        <li className="nav-item">
                            <a href="#" className="nav-link d-flex" aria-current="page"><BsHouseDoor/>
                                <Link to='/HomePage'>
                                    <h2 className="my-auto">Home</h2>
                                </Link>
                            </a>
                        </li>
                        <li className="nav-item">
                            <a href="#" className="nav-link d-flex"><BsSearch/>
                                <Link to='/ArtistPage'>
                                    <h2 className="my-auto">Search</h2>
                                </Link>
                            </a>
                        </li>
                        <li className="nav-item">
                            <a href="#" className="nav-link d-flex"><BsFillInboxFill/>
                                <h2 className="my-auto">Your Library</h2>
                            </a>
                        </li>
                    </ul>
                    <button type="button" className="btn rounded-pill btn-sign-up" onclick="window.location.href = '/login-page/login.html'">SIGN UP</button>
                    <button type="button" className="btn rounded-pill btn-log-in" onclick="window.location.href = '/login-page/login.html'">LOGIN</button>
